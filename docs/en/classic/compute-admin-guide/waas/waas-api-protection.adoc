...
+
To enable ban by Prisma Session ID, you must enable <<./waas_advanced_settings.adoc#prisma_session,Prisma Session Cookies>>. For more information on enabling Prisma Sessions and configuring ban definitions, see xref:./waas-advanced-settings.adoc[Advanced Settings].
