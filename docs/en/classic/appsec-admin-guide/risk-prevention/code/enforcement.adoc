...
To thoroughly examine the scan results of your repositories following the execution of an Enforcement configuration in the Prisma Cloud console, see the steps here for seamless and insightful review.
...
. Projects View
+
By default, you will see the *Projects* view, offering a comprehensive overview of your repositories. This view includes crucial information, such as *Failed PR*, *Pending PR*, and the *Latest PR*. This snapshot is enriched with data on *Weekly commits* and the number of *Git users* interacting with the repository.
...
. Code Reviews View
.. Select *Code Reviews* to gain real-time insights into the security status of repositories post-Enforcement configuration. Here, you have two key *Actions*:
+
