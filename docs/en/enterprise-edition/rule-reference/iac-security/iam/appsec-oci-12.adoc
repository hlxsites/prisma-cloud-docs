...
=== Impact
This rule identifies Oracle Cloud Infrastructure(OCI) accounts that do not have a lowercase character in the password rule for local (non-federated) users.
