...
=== Impact
This rule detects situations where the AWS Managed IAMFullAccess IAM rule is being used. The IAMFullAccess rule grants full permissions to manage all aspects of IAM, which can be a security threat if not managed correctly. 
