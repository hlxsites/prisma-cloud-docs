...
To fix the issue pointed out by this Cortex Cloud AppSec rule, you should update your API authorization procedure from the deprecated 'implicit' flow to another supported authorization flow such as 'authorizationCode' flow.
