...
// |*Search for Assets with Secret*
//RLP- to create a doc ticket

// | A new *Secret* findings in Investigate helps you prioritize or find assets with secret exposure risks. 5 attributes of secret findings. secret type > dropdown multiple secret type supported.
// Secret File Last Modified
//Secret File Path
//Secret ID
//Secret Severity
//Secret Type
