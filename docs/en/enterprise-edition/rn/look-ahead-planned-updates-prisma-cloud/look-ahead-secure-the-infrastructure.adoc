...
Read this section to learn about what is planned in the 25.11.1 CSPM Platform, Agentless Container Host, Agentless Host Security, CIEM, Data Security, and CDEM releases. 
