...
|Identifies AWS EC2 instances with network path from the internet (0.0.0.0/0). AWS EC2 instances with network path from the internet increases the risk of unauthorized access, cyber attacks, and data breaches, as it may provide a larger attack surface for malicious actors. Such instances are especially prone to brute force or vulnerability exploits.
...
|Identifies AWS EC2 instances with network path from the internet (0.0.0.0/0) on ports 80/443.
...
|Identifies AWS EC2 instances with network path from the internet (0.0.0.0/0) on ports 22/3389.
...
|Identifies AWS EC2 instances with network path from the untrust internet source on ports with high risk.
...
|Identifies AWS EC2 instances with network path to the internet (0.0.0.0/0).
...
|Identifies Azure Cosmos DB (PaaS) instances with network path from the untrust internet source.
...
|Identifies Azure MySQL (PaaS) instance with network path from the untrust internet source on TCP port 3306.
...
|Identifies Azure PostgreSQL (PaaS) instance with network path from the untrust internet source on TCP port 5432.
...
|Identifies Azure SQL Server (PaaS) with network path from the untrust internet source.
...
|Identifies Azure Virtual Machines with network path from the internet (0.0.0.0/0).
...
|Identifies Azure Virtual Machines with network path from the internet (0.0.0.0/0) on ports 80/443.
...
|Identifies Azure Virtual Machines with network path from the internet (0.0.0.0/0) on Admin ports.
...
|Identifies GCP VM instances with network path from the internet (0.0.0.0/0).
...
|Identifies GCP VM instances with network path from the internet (0.0.0.0/0) on ports 80/443.
...
|Identifies GCP VM instances with network path from the internet (0.0.0.0/0) on ports 22/3389.
...
|Identifies GCP VM instances with network path from the untrust internet source on ports with high risk.
