...
*Impact*–  Existing alerts will be resolved as `Policy_Deleted`. All policies related to AutoFocus will be defunct. RQL support for AutoFocus suggestions will also be be removed.
