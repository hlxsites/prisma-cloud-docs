...
|The /alert/v1/policy and /alert/v1/aggregate APIs will have an additional countDetails parameter in the response that will include totalAlerts. This parameter allows you to view the total number of alerts in review across the total number of policies on the Alerts Overview page.

//When filtering details on the alerts page, the total alert counter should be updated to reflect the new alert count. /alert/v1/policy and /alert/v1/aggregate
//  "countDetails": {
//   "totalAlerts": 100,
//    "totalPolicies": 30,
