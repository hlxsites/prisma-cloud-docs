...
|Prisma Cloud now supports CIS GKE version 1.5. This latest version has new controls and new Prisma cloud policies are mapped to the controls increasing the overall coverage.
...
|Prisma Cloud now supports CIS OCI version 2.0. This latest version has new controls and new Prisma cloud policies are mapped to the controls increasing the overall coverage.
...
|Prisma Cloud now supports CIS Azure Foundation benchmark version 2.1. This latest version has new controls and new Prisma cloud policies are mapped to the controls increasing the overall coverage.
