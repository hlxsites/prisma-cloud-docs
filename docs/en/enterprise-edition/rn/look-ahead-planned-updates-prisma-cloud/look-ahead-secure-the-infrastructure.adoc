...
The API now ingests following additional attributes:

* `TagOptions`
* `Tags`

The following permission is required for this attribute to be ingested.

* `servicecatalog:DescribePortfolio`


|*Amazon Glue Development Endpoint Data Processing*
tt:[Update]
//RLP-157243
