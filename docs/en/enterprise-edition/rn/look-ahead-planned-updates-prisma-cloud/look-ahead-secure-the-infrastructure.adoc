...
Read this section to learn about what is planned in the 24.3.1 CSPM Platform, Agentless container host, Agentless Host Security, CIEM, Data Security, and CDEM releases. The Look Ahead announcements are for an upcoming release and it is not a cumulative list of all announcements.
...
There are no Policy Updates for the 24.3.1 release.

[#api-ingestions]
=== API Ingestions

There are no API ingestions for the 24.3.1 release.
