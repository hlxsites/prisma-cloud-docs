...
The policy severity levels will be changed to better align with potential risk for the following IAM policies. Note that the existing alerts for the policies will be resolved as *Policy_Updated* and new alerts will be generated for policy violations.
