...
|In early August, the approval process once a new user is https://docs.prismacloud.io/en/enterprise-edition/content-collections/administration/add-prisma-cloud-users[created] in Prisma Cloud will be updated. This enhancement will help prevent unauthorized access or disruptive changes to sensitive CSP environments.
