...
//CWP-44666
|*Registry Scanning*
|Fixed an issue that caused previous scan results to be cleared when an on-demand scan completes successfully, subsequent to scheduled scans failing for an interval longer than the *Manage > System > Scan > Registry scan results* setting.
