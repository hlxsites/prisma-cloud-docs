...
For a more detailed explanation of this transition, see the link:https://main--prisma-cloud-docs-website--hlxsites.hlx.live/en/compute-edition/assets/pdf/lookahead-transition-to-vex-format.pdf[*Transition from Oval to VEX Files*] document.
