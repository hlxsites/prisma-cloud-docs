...
| https://pan.dev/compute/api/post-settings-logging/[Add Logging Settings | Develop with Palo Alto Networks] API includes a new parameter ‘cert’ under ‘Syslog’ to configure a TLS certificate.
