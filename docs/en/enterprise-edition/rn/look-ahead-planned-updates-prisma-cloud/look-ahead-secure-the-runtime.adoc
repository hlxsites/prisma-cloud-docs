...
=== Announcement
//CWP-61660
Prisma Cloud plans to use the following new additional NAT IP addresses on the Google Cloud for the respective Prisma Cloud Enterprise Edition (SaaS) regions.
