...
* *Module-Based Vulnerability Identification*: Scans will report vulnerabilities based on the module and stream configuration. This ensures accurate detection and avoids false positives or negatives caused by discrepancies in versioning or backported fixes.
...
*NOTE*: 
This enhancement will require upgrading Defenders to the latest version.