...
//CWP-46557
|tt:[Fixed in 32.01] *Container Support*
|Bump `github.com/containers/storage` to v1.42.0 (or later).

//CWP-46051
|tt:[Fixed in 32.01] *Documentation*
...
//CWP-42711
|tt:[Fixed in 32.01] *Serverless*
|Fixed confusion around the serverless function defended status.

//CWP-50500
|tt:[Fixed in 32.01] *Operating System Support*
...
//CWP-50312
|tt:[Fixed in 32.01] *Package Support*
