...
A hotfix for the recent Prisma Cloud Compute release (version 34.00) enables Prisma Cloud to detect nginx-ingress binaries with versions susceptible to #IngressNightmare. This hotfix was deployed on the Enterprise Edition (SaaS) version of Prisma Cloud Compute on Sunday, 30th March, 2025.
