...
|*CVEs for Red Hat RPM modules*

A modification to the Red Hat feed Package URL (PURL) format is causing issues with attributing CVEs to Red Hat RPM modules. We're working on a fix that will be included in an upcoming patch release.
