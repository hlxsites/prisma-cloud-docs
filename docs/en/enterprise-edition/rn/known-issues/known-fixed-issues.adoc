...
|A process execution issue is causing deviations in total, pass, and failed asset counts. 


*Imapct*: Inaccurate overall asset counts are displayed on *Asset Inventory* and *Compliance Dashboard*. 
