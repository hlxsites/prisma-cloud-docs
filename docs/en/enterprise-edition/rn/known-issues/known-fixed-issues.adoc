...
You can safely ignore the warning message for `backup:ListRecoveryPointsByBackupVault` permission because the aws-backup-recovery-point API is disabled by default.
...
|*Documentation Update for Additional Alibaba Permissions*
//RLP-156130/PCSUP-27518

tt:[25.8.1]

tt:[Secure the Infrastructure]

|Resolved an issue with Alibaba Cloud NAS not appearing in the Inventory results due to missing permissions for the Prisma Cloud role. Alibaba permissions are updated to include additional permissions for the following API:

* Alibaba File Storage NAS

* API Name: `alibaba-cloud-network-attach-storage``
