...
* Go package `golang.org/x/net` was updated to version `v0.17.0`. Refer to the https://github.com/advisories/GHSA-4374-p667-p6c8[golang.org/x/net] advisory.
