...
|*—* 
//added based on Slack request from Satheesh C related to PCSUP-26850
|In some cases, the *Alert Status* is being corrected due to which you may get alert notifications. 

*Resolution*—The correction will be completed by the end of February 2025.
...
A new scanner tag is created when an image is pulled for scanning. In some cases, this tag was not removed after the scan. This caused subsequent scans to fail.
