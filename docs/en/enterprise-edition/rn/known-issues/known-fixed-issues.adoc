...
//RLP-141312
|tt:[Fixed in 24.5.2]
|Fixed an issue that was causing an increased TTA for few function-based Aggregate or Join policies where major resources had not been recently updated. 
