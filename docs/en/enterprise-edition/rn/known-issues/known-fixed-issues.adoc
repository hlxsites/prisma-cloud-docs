...
|*Vulnerability Data Access Issue in Prisma Cloud Enterprise Edition*

*Issue*

Users of Prisma Cloud Enterprise Edition are currently experiencing an issue preventing access to vulnerability details detected by cloud security agents on Windows hosts. This data is inaccessible through both the user interface and the API.
