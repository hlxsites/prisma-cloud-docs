...
|The total count of alerts detected may sometimes increase even if assets in your tenant are not updated. Transient changes with AWS asset deletion and revival, may sometimes lead to this intermittent issue.
