...
|The *Resource Tag Filter* option was incorrectly enabled for all users on the Prisma Cloud console. Ennablement is restricted to users who signed up for the Limited General Availability (LGA) trial.
