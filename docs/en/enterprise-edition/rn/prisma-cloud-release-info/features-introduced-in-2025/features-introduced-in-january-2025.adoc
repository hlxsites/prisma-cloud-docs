...
//No Jira. Update provided by Dekel on Slack on 1/23/2025

|AWS Key Rotation permissions are now required to onboard Prisma Cloud DSPM. AWS key rotation is used to enhance security by regularly replacing cryptographic keys. See https://docs.prismacloud.io/en/enterprise-edition/content-collections/data-security-posture-management/prisma-cloud-dspm-deployment/deploy-prisma-cloud-dspm-on-aws/aws-permissions[AWS Permissions] for the full list of permissions required.
...
* https://https://pan.dev/prisma-cloud/api/cspm/get-remediation-for-policy/[Get Policy Remediation] 
