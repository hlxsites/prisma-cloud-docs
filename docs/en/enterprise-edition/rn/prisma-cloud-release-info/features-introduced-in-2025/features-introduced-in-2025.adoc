...
* xref:features-introduced-in-december-2025.adoc[Features Introduced in December 2025]
* xref:features-introduced-in-november-2025.adoc[Features Introduced in November 2025]
