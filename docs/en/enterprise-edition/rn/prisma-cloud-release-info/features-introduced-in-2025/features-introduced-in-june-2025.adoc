...
|The https://pan.dev/prisma-cloud/api/cspm/rl-audit-logs/[old] Audit Logs API is deprecated.

You can use the following new API that includes support for pagination and filtering:
