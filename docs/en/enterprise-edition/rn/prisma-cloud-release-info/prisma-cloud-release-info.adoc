...
The current release for Prisma Cloud Security Platform is 25.10.1.

*Note*: There was no release for Prisma Cloud Security Platform in 25.9.1.

If you are using Runtime Security, the current version is 34.01. 
