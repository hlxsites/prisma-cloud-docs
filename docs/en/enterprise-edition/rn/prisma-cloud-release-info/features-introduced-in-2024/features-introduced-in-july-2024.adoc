...
tt:[Secure the Runtime]
|All the current severity values for the Intelligence stream are mapped into 4 predefined values “Low”, “Medium”,“ High”, and “Critical”. 
...
The following table defines the vendor severity mapping to the predefined severity values:

[cols="1,1,1,1"]
!===
!Current Severity !New Severity!Vendor!Remarks
...
*Impact—* Customers using Debian Buster (LTS or ELTS) will no longer see vulnerability data for this version.
|===
