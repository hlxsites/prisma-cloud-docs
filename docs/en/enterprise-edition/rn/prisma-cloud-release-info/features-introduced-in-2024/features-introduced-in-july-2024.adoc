...
|*Identification of Third Party AI Libraries*
...
|The ‘Identification of 3rd party AI Libraries’ ’feature has been added to the ‘SBOM’ page under ‘Visibility’ in CAS. This feature detects Artificial Intelligence (AI) and Machine Learning (ML) functionalities incorporated into your codebase through third-party libraries, leveraging this information to build a comprehensive inventory of the machine learning packages in your environment, and allowing AppSec practitioners to make informed security decisions and effectively mitigate risks associated with machine learning packages.
Link: https://docs.prismacloud.io/en/enterprise-edition/content-collections/application-security/visibility/sbom/sbom
