...
|Microsoft's Azure Cloud Service Provider (CSP) has deprecated the following permissions and they are no longer required to run the Prisma Cloud Azure Onboarding Terraform template:
