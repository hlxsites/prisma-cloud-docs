...
For a more detailed explanation of this transition, see the https://main%2D%2Dprisma-cloud-docs-website\--hlxsites.hlx.live/en/compute-edition/assets/pdf/lookahead-transition-to-vex-format.pdf[Transition from Oval to VEX Files] document. For details on how CVEs are reported in the new VEX format as compared to the OVAL format, see https://main\%2D%2Dprisma-cloud-docs-website\--hlxsites.hlx.live/en/compute-edition/assets/pdf/oval-vex-cves-comparison.pdf[CVEs Comparison between Oval and VEX].
