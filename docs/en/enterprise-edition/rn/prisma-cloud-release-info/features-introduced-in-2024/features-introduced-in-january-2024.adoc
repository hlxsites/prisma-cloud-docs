...
|Prisma Cloud's *Dashboards > Add Dashboard > Widget Selector* now includes two additional widgets to help you easily report on your organizations efficiency in responding to alerts. Widgets are currently available to System Administrators and include:
