...
* Select *Send To > Email*, enter the email address or addresses (comma-separated list) of the person to whom you want to send the alert notification, enter a message (optional), and click Send. The recipient will receive an email with the alert details and remediation steps to resolve the alert (if applicable).
+
image::send-to-email.png[]

* Select *Send To > Slack*, enter or select the Slack channel where you want to send the alert notification, enter a message (optional), and click Send. The specified channel will receive the alert details and remediation steps to resolve the alert (if applicable).
+
image::send-to-slack.png[]
