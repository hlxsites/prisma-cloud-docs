...
|New Response property `dataSensitivityDatatypeDetails` added to *GET - /alert/v1/{id}/graph* endpoint. This property provides data sensitivity details (data type, number of occurrences , and sensitivity label) to returned evidence graph objects
