...
Use the *Application Inventory* page to inspect and analyze your applications. You can also search and investigate applications using the Application query attributes available on the *Investigate* page.
