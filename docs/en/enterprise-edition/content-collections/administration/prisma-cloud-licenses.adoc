...
Only resources that are active (or running) count towards Prisma Cloud credit usage. Non-active (or dormant) resources do not count towards credit usage. Credits are also not counted for resources that belong to disabled cloud accounts. 
