...
+
image::administration/add-trusted-list-dns-policies-1.png[]
...
+
image::administration/add-domain-trusted-list-dns-1-1.png[]
...
+
image::administration/add-domain-trusted-list-dns-2-1.png[]
+
