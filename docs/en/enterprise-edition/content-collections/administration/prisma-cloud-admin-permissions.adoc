...
[NOTE]
====
When you configure permission groups, keep in mind that Investigate functions listed below, that utilize a `config from network` query require both READ config and READ network permissions to work.
====
