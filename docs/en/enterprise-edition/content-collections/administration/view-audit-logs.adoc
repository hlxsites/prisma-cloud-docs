...
[NOTE]
====
To ensure optimal performance and user experience, audit logs returned are capped at 100,000. If this number is exceeded you will receive an error message. Modify the request time range to limit records to under 100,000.
====
