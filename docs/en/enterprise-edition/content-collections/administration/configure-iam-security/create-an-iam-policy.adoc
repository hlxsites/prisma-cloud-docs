...
+
image::administration/iam-excessive-permissions.png[]
...
+
image::administration/create-an-iam-policy-rql-example.png[]
...
+
image::administration/create-an-iam-policy-success.png[]
+
...
+
image::administration/iam-policy-filter.png[]
+
image::administration/iam-policy-filter-ootb.png[]
