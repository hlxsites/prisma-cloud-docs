...
Action Plans are part of the Prisma Cloud Platform, offering seamless integration with existing cloud security tools:
...
* Integration: Data ingestion across all Prisma Cloud platform tools to gather and group together findings allowing you to focus on faster resolution.
