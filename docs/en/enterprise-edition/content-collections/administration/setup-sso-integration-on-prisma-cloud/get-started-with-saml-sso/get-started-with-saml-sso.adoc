...
. Direct your users to the following URL for Idp intiiated login:
https://appX<where X is the instance where your tenant is provisioned, for example app3>.prismacloud.io/login 
