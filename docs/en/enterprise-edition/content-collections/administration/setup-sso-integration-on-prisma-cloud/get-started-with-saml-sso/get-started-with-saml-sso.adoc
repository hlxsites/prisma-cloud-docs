...
NOTE: If you have an Access URL defined use that URL for login, alternatively use your xref:../../access-prisma-cloud#id3c964e17-24c6-4e7c-9a47-adae096cc88d.adoc[federated login URL].
