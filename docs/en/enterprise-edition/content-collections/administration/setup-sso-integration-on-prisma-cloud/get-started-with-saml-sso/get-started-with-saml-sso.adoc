...
. Direct your users to the following URL for Idp intiiated login, https://appX.prismacloud.io/login (where X is the instance where your tenant is provisioned, for example app3) 
