...
.. The integration will be listed on the *Integrations* page, where you can *View*, *Edit*, or *Delete* the integration as needed.
+
...
.. Use *Config Query* for visibility of host vulnerabilities.
+
...
.. Use *Network Query* for visibility of host vulnerabilities.
+
