...
Add trusted IP addresses to permit access to the management interfaces or to label your internal networks on Prisma® Cloud and exclude them from anomaly alerts and RQL queries. Trusted IP addresses are limited to a maximum of 10.
