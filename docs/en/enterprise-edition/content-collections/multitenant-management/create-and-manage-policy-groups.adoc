...
. Select the *Policy Groups* tab from the Multitenancy Management console. 
...
The Prisma Cloud Multitenancy Management console also enables you to create a new policy called a custom policy. A custom policy can be added to a new or existing policy group, for the purpose of mapping the policy to tenants in a tenant group. 
