...
Starting from Prisma Cloud Compute "Iverson" (release 21.xx), which shipped in the second half of calendar year 2021, Prisma Cloud has extended the support lifecycle as explained in the following sections. 
