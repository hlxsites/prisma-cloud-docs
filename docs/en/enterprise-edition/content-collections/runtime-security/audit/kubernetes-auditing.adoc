...
Prisma Cloud supports self-managed clusters. See https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-compute/install/system-requirements[here] for supported Kubernetes versions.
...
+
image::runtime-security/kubernetes_auditing.png[width=800]
...
image::runtime-security/kubernetes_aks_diagram_audit.png[width=800]
...
image::runtime-security/kubernetes_eks_diagram_audit.png[width=800]
