...
Whereas Defender's runtime system surfaces suspect activity by sifting through events, Defender's xref:../runtime-defense/incident-explorer.adoc#_forensics[forensics] system presents a raw list of all spawned processes.
