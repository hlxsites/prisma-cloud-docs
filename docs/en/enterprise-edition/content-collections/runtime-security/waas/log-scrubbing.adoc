...
+
image::./waas-log-scrubbing-new-rule-dialog-location.png[width=200]
...
+
image::./waas-log-scrubbing-scrubbed-event.png[width=200]
+
[NOTE]
====
If sensitive data triggers events, both the forensic message and the recorded HTTP request are scrubbed.

image::./waas-log-scrubbing-scrubbed-payload.png[width=250]
====
