...
image::./waas-dos-protection.png[width=750]
...
+
image::./waas-dos-protection-toggle.png[width=650]
. Set the effect with the <<dos_actions,action>> to apply once a threshold is reached.
+
image::./waas-dos-action.png[width=650]
+
...
+
image::./waas-dos-new-condition.png[width=650]
+
...
+
image::./waas-dos-multi.png[width=650]
+
...
+
image::./waas-dos-excluded.png[width=650]
