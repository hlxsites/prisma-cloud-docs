...
image::runtime-security/cnaf_deployment_example.png[width=650]
...
+
image::runtime-security/waas_nginx_scope.png[width=550]
...
image::runtime-security/waas_rule_example.png[width=650]
