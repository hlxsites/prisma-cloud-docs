...
+
image::runtime-security/waas_deployment_types_serverless.png[width=400]
...
+
image::runtime-security/waas_serverless_collections.png[width=550]

. Select the protections to enable.
+
image::runtime-security/waas_serverless_protections_view.png[width=550]
