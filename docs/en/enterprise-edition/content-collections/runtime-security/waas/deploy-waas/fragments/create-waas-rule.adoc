...
+
image::runtime-security/waas_select_scope.png[]
+
...
+
image::runtime-security/waas_define_collection.png[width=250]
+
...
+
image::runtime-security/waas_define_host_collection.png[width=250]
ifdef::waas_oob_hosts[]
image::runtime-security/waas_define_collection_oob_hosts.png[width=250]
