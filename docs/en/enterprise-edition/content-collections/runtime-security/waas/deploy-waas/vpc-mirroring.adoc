...
+
image::runtime-security/aws_agentless_permissions_stack.png[width=250]
+
WAAS agentless resources stack deployed in AWS:
+
image::runtime-security/aws_agentless_setup_stack.png[width=250]
...
+
image::runtime-security/waas_out_of_band_app_firewall.png[width=750]
...
+
image::runtime-security/waas_out_of_band_bot_protection.png[width=750]
...
+
image::runtime-security/waas_out_of_band_advanced_settings.png[width=750]
