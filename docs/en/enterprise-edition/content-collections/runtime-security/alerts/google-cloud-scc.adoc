...
+
image::runtime-security/alerts_gcss_svc_account.png[width=750]
...
+
image::runtime-security/alerts_gcss_api_key1.png[width=450]

. Save the API key.
We recommended that you restrict the key to the *Cloud Security Command Center API*.
+
image::runtime-security/alerts_gcss_api_key2.png[width=600]
...
+
image::runtime-security/alerts_gcss_role.png[width=750]
