...
+
image::runtime-security/alerts-gcss-svc-account.png[width=750]
...
+
image::runtime-security/alerts-gcss-api-key1.png[width=450]

. Save the API key.
We recommended that you restrict the key to the *Cloud Security Command Center API*.
+
image::runtime-security/alerts-gcss-api-key2.png[width=600]
...
+
image::runtime-security/alerts-gcss-role.png[width=750]
