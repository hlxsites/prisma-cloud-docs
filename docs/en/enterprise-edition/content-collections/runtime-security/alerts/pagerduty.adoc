...
. Click *New Service*.
+
image::runtime-security/pagerduty_create_new_service.png[width=100]
...
+
image::runtime-security/pagerduty_add_service_form.png[width=600]

. Click *Add Service*.
You're taken to *Integrations* tab for the Prisma Cloud service.
+
image::runtime-security/pagerduty_add_service.png[width=100]

. Copy the *Integration Key*, and set it aside.
You'll use it to configure the integration in Prisma Cloud Console.
+
image::runtime-security/pagerduty_integration_key.png[width=600]
...
+
image::runtime-security/pagerduty_review_test_alert.png[width=800]
