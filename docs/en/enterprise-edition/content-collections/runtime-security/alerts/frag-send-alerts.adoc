...
image::runtime-security/aws_security_hub_config.png[]
...
image::runtime-security/google_cloud_pub_sub_config.png[]
endif::google_cloud_pub_sub[]

ifdef::google_cloud_scc[]
image::runtime-security/google_cloud_scc_config.png[]
endif::google_cloud_scc[]

ifdef::ibm_cloud_security_advisor[]
image::runtime-security/ibm_cloud_security_advisor_config.png[]
endif::ibm_cloud_security_advisor[]

ifdef::jira_alerts[]
image::runtime-security/jira_config.png[]
endif::jira_alerts[]

ifdef::pagerduty_alerts[]
image::runtime-security/pagerduty_config.png[]
...
ifdef::xdr_alerts[]
image::runtime-security/cortex_xdr_config.png[]
endif::xdr_alerts[]

ifdef::xsoar_alerts[]
image::runtime-security/cortex_xsoar_config.png[]
endif::xsoar_alerts[]
