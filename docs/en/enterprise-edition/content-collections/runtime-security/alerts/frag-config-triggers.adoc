...
+
ifdef::jira_alerts[]
image::runtime-security/frag_config_jira_triggers.png[]
endif::jira_alerts[]

ifdef::servicenow_vr_alerts[]
+
image::runtime-security/frag_config_servicenow_vr_triggers.png[]
...
+
image::runtime-security/frag_config_triggers.png[]
