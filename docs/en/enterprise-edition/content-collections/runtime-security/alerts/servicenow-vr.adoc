...
+
image::runtime-security/alerts-servicenow-new-resource.png[width=700]
...
+
image::runtime-security/alerts-servicenow-base-api-path.png[width=700]
...
image::runtime-security/servicenow-vr-config.png[width=800]
...
+
image::runtime-security/servicenow-vr-fix-script.png[width=800]
...
+
image::runtime-security/servicenow-vr-identification-rule.png[width=800]
