...
+
image::runtime-security/alerts_servicenow_new_resource.png[width=700]
...
+
image::runtime-security/alerts_servicenow_base_api_path.png[width=700]
...
image::runtime-security/servicenow_vr_config.png[width=800]
...
+
image::runtime-security/servicenow_vr_fix_script.png[width=800]
...
+
image::runtime-security/servicenow_vr_identification_rule.png[width=800]
