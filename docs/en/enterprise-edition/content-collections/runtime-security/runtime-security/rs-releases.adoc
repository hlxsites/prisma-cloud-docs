...
image::runtime-security/update_bell.png[width=800]
...
+
image::runtime-security/releases_csp.png[width=800]
...
+
image::runtime-security/releases_pdf.png[width=400]

. Scroll down to the release information to get the link.
+
image::runtime-security/releases_direct_link.png[width=800]
