...
image::runtime-security/image-sandbox-main-page.png[]

image::runtime-security/image-sandbox-results-a.png[]

image::runtime-security/image-sandbox-results-b.png[]
...
image::runtime-security/image-sandbox-networking.png[]
...
image::runtime-security/image-sandbox-dialog.png[]
