...
+
image::runtime-security/runtime_defense_app_embedded_fs_mon_enabled.png[width=600]

* A custom rule is attached to an App-Embedded runtime rule.
For example:
+
image::runtime-security/runtime_defense_app_embedded_custom_rule.png[width=600]
...
image::runtime-security/runtime_defense_app_embedded_obvervations_metadata.png[width=800]
