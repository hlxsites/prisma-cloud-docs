...
image::runtime-security/runtime_defense_734302.png[width=600]
...
image::runtime-security/runtime_defense_overview_model.png[width=600]
...
image::runtime-security/runtime_defense_overview_container_model_capabilities.png[width=600]
...
image::runtime-security/runtime_defense_792723.png[width=600]
...
image::runtime-security/runtime_defense_rule_scope.png[width=350]
...
image::runtime-security/block_containers_audits.png[width=650]
...
image::runtime-security/runtime_defense_fs_584208.png[width=650]
