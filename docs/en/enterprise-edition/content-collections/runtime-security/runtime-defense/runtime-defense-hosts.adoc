...
+
image::runtime-security/host_runtime_rule.png[width=700]
...
image::runtime-security/runtime_defense_hosts_fim_rule.png[width=600]
...
image::runtime-security/host_runtime_apps.png[width=700]
...
image::runtime-security/host_runtime_ssh_history.png[width=700]
...
image::runtime-security/host_runtime_update_compliance_check.png[width=700]
