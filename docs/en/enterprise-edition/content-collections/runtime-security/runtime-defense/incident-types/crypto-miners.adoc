...
image::runtime-security/crypto_miner_incident.png[width=800]
...
+
image::runtime-security/crypto_miner_action.png[width=400]
...
image::runtime-security/crypto_miner_image_report.png[width=600]
...
image::runtime-security/crypto_miner_csv.png[width=800]
