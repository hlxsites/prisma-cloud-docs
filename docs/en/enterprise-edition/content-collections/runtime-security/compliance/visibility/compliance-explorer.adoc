...
image::runtime-security/compliance_explorer_overview.png[width=900]
...
image::runtime-security/compliance_explorer_tabs.png[width=900]

Filters let you show failed checks only by setting the *Status* key to *Failed*:

image::runtime-security/compliance_explorer_filter.png[width=900]
