...
.. Click *Save*.
+
image::runtime-security/docker_enterprise_disa_stig_container_template.png[width=600]
...
.. Click *Save*.
+
image::runtime-security/docker_enterprise_disa_stig_host_template.png[width=600]
