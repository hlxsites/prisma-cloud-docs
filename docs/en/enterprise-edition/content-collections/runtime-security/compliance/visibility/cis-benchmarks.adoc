...
When updating the Openshift CIS benchmark from v1.1.0 to v1.3.0, configure your clusters to follow the 600 permissions compliance instead of the 644.
If you have configured a blocking action, change the action to alert until until your clusters follow the new 600 compliance.
Log onto the https://workbench.cisecurity.org/files/4260[CIS website] to review the details of the Openshift 1.30 benchmarks.
