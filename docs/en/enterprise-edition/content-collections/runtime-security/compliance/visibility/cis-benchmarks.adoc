...
image::runtime-security/cis_benchmarks_versions.png[width=600]

*Grades* -- To see Prisma Cloud's grade for a check, see the corresponding *Severity* column.

image::runtime-security/cis_benchmarks_grades.png[width=500]
...
image::runtime-security/cis_benchmarks_templates.png[width=500]
