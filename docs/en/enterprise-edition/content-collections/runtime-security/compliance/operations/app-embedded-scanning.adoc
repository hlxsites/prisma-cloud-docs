...
+
image::runtime-security/fargate_image_comp_scan_result.png[width=600]
...
+
image::runtime-security/app_embedded_scanning_observations.png[width=800]
+
The *Environment* tab shows cloud-provider metadata that App-Embedded Defender collected about the running container.
For more information about the type of cloud-provider metadata App-Embedded Defender can collect, see xref:../../runtime-defense/runtime-defense-app-embedded.adoc#_cloud_metadata[Monitoring workloads at runtime].
+
image::runtime-security/app_embedded_scanning_metadata.png[width=800]
