...
+
image::runtime-security/fargate-image-comp-scan-result.png[]
...
+
image::runtime-security/app-embedded-scanning-observations.png[]
+
...
+
image::runtime-security/app-embedded-scanning-metadata.png[]
