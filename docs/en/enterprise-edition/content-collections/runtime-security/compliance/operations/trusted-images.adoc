...
+
image::runtime-security/trusted_images_trust_badge.png[width=50]

* Untrusted.
An image is considered untrusted if it's untrusted on at least one host.
+
image::runtime-security/trusted_images_not_trusted_badge.png[width=50]
...
image::runtime-security/trusted_images_trust_group_manual.png[width=700]
...
image::runtime-security/trusted_images_trust_group_filters.png[width=700]
