...
image::runtime-security/jenkins_pipeline_k8s_start_slave_pod.png[Start slave pod,400]
...
image::runtime-security/jenkins_pipeline_k8s_pod_template.png[Pod template,400]
