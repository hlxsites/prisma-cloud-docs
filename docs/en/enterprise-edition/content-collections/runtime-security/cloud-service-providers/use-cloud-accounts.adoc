...
+
image::runtime-security/credentials_store_prisma_cloud_oboarding.png[width=800]
...
+
image::runtime-security/credentials_store_surface_prisma_cloud_cred.png[width=500]

. Click *Save*.

. You can use the credential in Compute to set up features like registry scanning.
+
image::runtime-security/credentials_store_config_reg_scanning.png[width=500]
