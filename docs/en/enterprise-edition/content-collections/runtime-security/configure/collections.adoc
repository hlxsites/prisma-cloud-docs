...
image::runtime-security/collections_policy_table_scopes.png[width=800]
...
image::runtime-security/collections_rule_scope.png[width=700]
...
+
image::runtime-security/collections_specify_filter.png[width=300]
...
image::runtime-security/collections_792004.png[]
