...
+
image::runtime-security/tags_define_tag.png[width=600]
+
. Click *Save*.
...
image::runtime-security/tags_add_tag_assignment.png[width=600]
...
image::runtime-security/tags_edit_tag_assignment.png[width=600]
...
image::runtime-security/tags_assigned_from_scan_reports.png[width=800]

image::runtime-security/tags_specific_images.png[width=600]

image::runtime-security/tags_images_with_wildcard.png[width=600]
...
image::runtime-security/tags_filters_a.png[width=600]

image::runtime-security/tags_filters_b.png[width=600]
