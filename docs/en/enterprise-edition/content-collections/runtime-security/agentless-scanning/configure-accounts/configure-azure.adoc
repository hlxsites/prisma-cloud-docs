...
* *Ephemeral OS Disks Unsupported:* Prisma Cloud does not support Ephemeral disks for agentless scanning because Azure does https://learn.microsoft.com/en-us/azure/virtual-machines/ephemeral-os-disks#unsupported-features[not support] taking snapshots of hosts with Ephemeral OS disks.