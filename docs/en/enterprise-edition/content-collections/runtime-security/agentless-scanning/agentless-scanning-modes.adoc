...
. In the *Runtime Security > Manage > Cloud accounts* page, click *Hide/show columns* icon in the top-right corner of the Accounts table.
+
image::runtime-security/Hide-show-column.png[width=800]

. In the *Configure Columns* dialog box, select *Scan mode*, and click *Done*.
+
image::runtime-security/agentless-scan-mode-selection.png[width=600]
...
image::runtime-security/scan-mode-filter.png[width=800]
