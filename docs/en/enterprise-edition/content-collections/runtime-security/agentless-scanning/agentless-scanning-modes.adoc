...
You can filter the accounts further based on a specific scanning mode. In *Filter by keywords and attributes*, select *Scan Mode* and then select the specific mode. 
