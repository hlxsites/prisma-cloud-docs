...
+
image::runtime-security/aad_saml_20210728_1.png[width=400]
+
. The _Compute-Console_ overview page will appear, select *2. Single sign-on* and then choose *SAML*
+
image::runtime-security/aad_saml_20210728_2.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_3.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_4.png[width=600]
+
...
+
image::runtime-security/aad_saml_20210728_5.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_6.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_7.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_10.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_12.png[width=600]
...
+
image::runtime-security/aad_saml_20210728_13.png[width=600]
+
...
+
image::runtime-security/aad_saml_20210728_8.png[width=800]
...
+
image::runtime-security/aad_saml_20210728_9.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad_saml_20210728_11.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad_saml_20210728_14.png[width=600]
...
. Click *Save*
+
image::runtime-security/aad_saml_20210728_15.png[width=600]
+
