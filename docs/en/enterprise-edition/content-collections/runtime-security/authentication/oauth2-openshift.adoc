...
image::runtime-security/oauth_openshift_flow.png[width=800]
...
+
image::runtime-security/oauth2_login.png[width=250]

.. Authorize the Prisma Cloud OAuth App to sign you in.
+
image::runtime-security/oauth2_github_authorization.png[width=500]
