...
image::runtime-security/prisma_cloud_mgmt_interfaces.png[width=800]
...
image::runtime-security/prisma_cloud_role_mapping.png[width=800]
...
+
image::runtime-security/access_keys_list.png[width=800]
...
image::runtime-security/access_keys_path_to_console.png[width=800]
