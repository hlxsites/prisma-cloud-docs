...
+
image::runtime-security/adfs_saml_1.png[width=600]
...
+
image::runtime-security/adfs_saml_2.png[width=600]

.. Step Select Data Source: select *Enter data about the relying party manually*.
+
image::runtime-security/adfs_saml_3.png[width=600]

.. Step Specify Display Name: In *Display Name*, enter *twistlock Console*.
+
image::runtime-security/adfs_saml_4.png[width=600]
...
+
image::runtime-security/adfs_saml_5.png[width=600]

.. Step Configure Identifiers: for example enter *twistlock* all lower case and click *Add*.
+
image::runtime-security/adfs_saml_6.png[width=600]
+
...
+
image::runtime-security/adfs_saml_7.png[width=600]
...
+
image::runtime-security/adfs_saml_8.png[width=600]
...
+
image::runtime-security/adfs_saml_9.png[width=600]
...
+
image::runtime-security/adfs_saml_10.png[width=600]
+
...
+
image::runtime-security/adfs_saml_11.png[width=600]
...
+
image::runtime-security/adfs_saml_12.png[width=600]
...
. Assign the *Role*.
+
image::runtime-security/adfs_saml_13.png[width=600]
+
