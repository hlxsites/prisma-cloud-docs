...
+
image::runtime-security/integrate_saml_610130.png[width=600]

. On the left, click *Create new app*.
+
image::runtime-security/integrate_saml_610131.png[width=600]

. Select *SAML 2.0*, and then click *Create*.
+
image::runtime-security/integrate_saml_610135.png[width=600]

. In the *App name* field, enter *Prisma Cloud Console*, then click *Next*.
+
image::runtime-security/integrate_saml_610136.png[width=600]
...
+
image::runtime-security/integrate_saml_610140.png[width=600]
...
+
image::runtime-security/integrate_saml_610146.png[width=600]

. Click *Next*, and then click *Finish*.
+
You are directed to a summary page for your new app.
+
image::runtime-security/integrate_saml_610150.png[width=600]

. Click on the *People* tab, and add users to the Prisma Cloud app.
+
image::runtime-security/integrate_saml_610156.png[width=600]

. Click on the *Groups* tab, and add groups to the Prisma Cloud app.
+
image::runtime-security/integrate_saml_610160.png[width=600]
...
* X.509 Certificate
+
image::runtime-security/integrate_saml_610163.png[width=600]
