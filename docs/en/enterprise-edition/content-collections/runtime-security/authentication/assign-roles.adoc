...
image::runtime-security/saas_assign-roles_role.png[width=600]
...
+
image::runtime-security/saas_assign-roles_accountgroup.png[width=600]
+
...
+
image::runtime-security/saas_assign-roles_resourcelist.png[width=600]
+
...
+
image::runtime-security/saas_assign-roles_user.png[width=400]
+
