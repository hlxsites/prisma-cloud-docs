...
image::runtime-security/install_app_embedded_defender_fargate_runtime_rule_scope.png[width=500]
...
image::runtime-security/install_app_embedded_defender_fargate_waas_scope.png[width=500]
...
+
image::runtime-security/connected_fargate_defenders.png[width=500]
...
image::runtime-security/connected_app_embedded_defenders.png[width=800]
...
image::runtime-security/fargate_jenkins_repo.png[width=600]
...
. Run *Build Now*.
+
image::runtime-security/fargate_jenkins_stage.png[width=600]
...
+
image::runtime-security/fargate_jenkins_archive.png[width=600]
