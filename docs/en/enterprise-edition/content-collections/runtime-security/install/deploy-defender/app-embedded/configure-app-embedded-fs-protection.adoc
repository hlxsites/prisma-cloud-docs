...
+
image::runtime-security/config_app_embedded_fs_protection_global.png[width=800]
...
+
image::runtime-security/config_app_embedded_fs_protection_deploy.png[width=800]
