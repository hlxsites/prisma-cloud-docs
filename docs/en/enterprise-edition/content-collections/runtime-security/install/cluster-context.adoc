...
NOTE: For Azure AKS, cluster name detection is not supported for clusters deployed within custom resource groups. As a fallback use the server extracted from the kubeconfig.  
