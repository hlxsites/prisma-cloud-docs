...
[NOTE]
====
For your query to work properly, make sure that RQL json.rule functions are wrapped in single quotes (``). If you don't add the single quotes, the RQL will not be valid and cannot be executed.
====
