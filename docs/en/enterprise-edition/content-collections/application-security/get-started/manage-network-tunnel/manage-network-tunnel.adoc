...
* *Configure DNS Records*: Create an *A Record* or a *CNAME Record* to direct traffic to the VM hosting the Docker Container or the Kubernetes (k8s) service. Example: https://prisma-transporter.example.com.
+
