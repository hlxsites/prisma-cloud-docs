...
To verify that the Transporter has been successfully integrated, in *Application Security* select *Home* > *Settings > Manage Network Tunnels > Manage Integrations*. Check that the Transporter name is displayed in the *Transporter* field.
