...
* In the the https://marketplace.visualstudio.com/items?itemName=PrismaCloud.prisma-cloud[Visual Studio Marketplace] > search for *Prisma Cloud* > select the Prisma Cloud plugin
...
.. In *Application Security*, select *Settings* > *Appliaction Security* under Configure in the left navbar
