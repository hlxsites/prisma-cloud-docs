...
* Create a Terraform 'Organization' and 'Workspace'. Refer to xref:add-terraform-cloud-sentinel.adoc[Terraform Cloud (Sentinel)] for more on creating organizations and workspaces
...
. Select a Terraform workspace from the menu.
+
