...
See xref:../../../cli/cli-checkov-output-prisma-cloud.adoc[Checkov Output on Prisma Cloud Console] for more on Checkov.
...
* For additional installation methods, see xref:../../../cli/cli-integrations/cli-integrations.adoc[Installing Checkov].
...
----
+
NOTE: See the Checkov xref:../../../cli/cli-cmnd-ref.adoc[CLI Command Reference] for more advanced Checkov run settings, such  as `--file`, `--check`, `--framework`. 
