...
Note: Currently, the AWS CodeCommit integration supports only periodic scans. Support for Pull Request scans is coming soon. The feature will be available automatically upon release without requiring any updates on your side.
