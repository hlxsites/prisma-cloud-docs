...
. Before you begin.
.. Grant the Prisma user integrating Prisma Cloud with GitLab user permissions in the relevant GitLab organization as specified in <<#user-permissions, User Permissions>> below.
