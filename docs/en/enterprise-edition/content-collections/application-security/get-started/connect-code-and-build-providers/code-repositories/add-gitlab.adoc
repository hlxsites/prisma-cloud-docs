...
. Before you begin.
.... Grant the Prisma user integrating Prisma Cloud with GitLab user permissions in the relevant GitLab organization. Refer to <<#user-permissions, User Permissions>> below for the list of required permissions.
