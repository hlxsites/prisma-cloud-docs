...
* This integration only supports the default port 443

. Paste the Bitbucket PAT generated in _step 3_ of the prerequisites above in the *Bitbucket Personal Access Token* field of the *Create Personal Access Token* step of the wizard > *Register*.
+
