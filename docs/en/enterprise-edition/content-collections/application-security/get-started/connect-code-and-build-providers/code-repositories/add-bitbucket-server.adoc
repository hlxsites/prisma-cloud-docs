...
Prisma Cloud supports multiple integrations for Bitbucket Server/Data Center instances. After the initial integration with Prisma Cloud, you can continue to add additional organizations and workspaces using a different or the same user or team token.
