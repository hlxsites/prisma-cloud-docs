...
[.procedure]
. Before you begin.
.. Grant the Prisma user integrating Prisma Cloud with GitHub Server user permissions in the relevant GitHub organization. Refer to <<#user-permissions, User Permissions>> below for the list of required permissions.
