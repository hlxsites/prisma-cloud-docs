...
For more information, refer to xref:../software-composition-analysis/software-composition-analysis.adoc#runtime-vulnerabilities[Mitigate Runtime Vulnerabilities at Source].
////
