...
=== Last Scan of a Repository

Currently, the last scan date of a repository only relates to Infrastructure-as-Code (IaC) scans. The IaC module must be enabled to display this feature.  
