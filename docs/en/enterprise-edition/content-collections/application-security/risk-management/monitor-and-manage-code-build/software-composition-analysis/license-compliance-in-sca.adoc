...
For more information on default license policies refer to xref:../../../../policy-reference/secrets-policies/license-policies.adoc[License Policies].
...
For more information on Suppression, refer to the xref:../monitor-and-manage-code-build/software-composition-analysis/suppress-code-issues.adoc[Suppress Code Issues] documentation.
