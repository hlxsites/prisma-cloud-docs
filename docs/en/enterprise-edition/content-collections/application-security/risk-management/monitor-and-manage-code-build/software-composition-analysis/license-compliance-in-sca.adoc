...
. On *Projects* and then select *Category* - *Licenses*.

+
image::application-security/sca-24.png[]

. Access a specific license vulnerability to suppress.
+
image::application-security/sca-25.png[]
...
+
image::application-security/sca-29.png[]
...
+
image::application-security/sca-31.png[]

. Select *Submit* to enable suppression.
+
image::application-security/sca-32.png[]
