...
+
Using *View Drift Details*, you can access the drift on *Projects* and choose to *Fix* or *Suppress* the drift (if the status is open). You can also choose to view the alert origin on the AWS or Azure cloud platform by selecting *View in Console*.
+
