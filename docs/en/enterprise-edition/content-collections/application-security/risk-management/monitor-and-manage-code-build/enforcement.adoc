...
+
image::application-security/enfor.png
...
+
image::application-security/enfor-5.png
...
+
image::application-security/enfor-7.png

.. Select the repositories you want to add the exception.
+
image::application-security/enfor-8.png
+
...
+
image::application-security/enfor-14.png
