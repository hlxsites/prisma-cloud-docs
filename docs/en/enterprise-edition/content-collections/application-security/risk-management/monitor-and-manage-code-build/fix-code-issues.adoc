...
+
. (Optional): Customize the Pull Request and branch names.
.. Select *Use custom Pull Request title and branch name*.
...
. Click on a link in the popup or access the PR on your VCS console to view the PR with your custom title.
+
