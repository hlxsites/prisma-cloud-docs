...
//image::application-security/icon_app_graph.png
...
// new image::application-security/repositories_overview.png

* The *Contributors* tab includes details about the contributors and their permissions to the repository

// new image::application-security/repositories_contributors.png
...
+
image::application-security/application-graph1.1.png
