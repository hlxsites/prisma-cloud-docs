...
|View an inventory of Jenkins plugins across your organization's Jenkins plugins, allowing you to remove unused plugins and to assess, prioritize and remediate CVE vulnerabilities
