...
Configure logging to capture and store system events, errors, and activities for analysis and troubleshooting purposes by adding an environment variable. See step 4.2 *Option #2: Run Image through Docker Compose* for details. 
