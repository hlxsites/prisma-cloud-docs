...
* *Permissions*: The least possible user privileges or System Administrator privileges if using a https://docs.prismacloud.io/en/enterprise-edition/content-collections/administration/add-service-account-prisma-cloud[Service Account token (Key/Secret)]
