...
. Environment Setup.
+
* On *Mac*: Install https://www.python.org/downloads/[Python] v3.8 or above, https://docs.pipenv.org/[Pipenv], or a running https://www.docker.com/products/docker-desktop[Docker] daemon
