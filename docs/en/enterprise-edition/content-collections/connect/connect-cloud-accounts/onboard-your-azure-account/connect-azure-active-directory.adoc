...
[NOTE]
====
Misconfigurations in your Azure subscription may lead to errors when onboarding your Azure Active Directory account. Register the `Microsoft.Subscriptions` resource provider for the affected subscriptions to resolve the issue.
====
