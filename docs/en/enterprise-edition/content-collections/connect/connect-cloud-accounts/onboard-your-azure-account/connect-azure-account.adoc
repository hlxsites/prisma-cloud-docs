...
* xref:connect-azure-tenant.adoc[Add Azure Tenant (Root tenant level]
* xref:connect-azure-subscription.adoc[Add Azure Subscription (Individual subscription level)]
* xref:connect-azure-active-directory.adoc[Add Azure Active Directory (IAM module at root tenant level)]
