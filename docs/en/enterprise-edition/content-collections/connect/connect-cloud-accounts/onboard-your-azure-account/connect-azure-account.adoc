...
+
tt:[NOTE:] Entra ID authentication for Azure flowlogs is supported only for GPV2 https://learn.microsoft.com/en-us/azure/storage/common/storage-account-create?tabs=azure-portal[storage accounts]. Legacy GPV1 accounts are not supported. 
+
