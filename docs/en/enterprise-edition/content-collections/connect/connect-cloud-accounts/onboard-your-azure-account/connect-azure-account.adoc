...
* Grant Storage Blob permissions at the tenant level, to ensure proper data ingestion. You will encounter a missing permissions error if you provide storage account/blob level access without tenant-level access. 
