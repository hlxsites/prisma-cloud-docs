...
- On the Azure portal, set Public Network Access to *Enabled from selected virtual networks and IP addresses* (Recommended). 
- Add the IP addresses and NAT Gateway source and directory IPs listed https://docs.prismacloud.io/en/classic/cspm-admin-guide/get-started-with-prisma-cloud/enable-access-prisma-cloud-console#idcb6d3cd4-d1bf-450a-b0ec-41c23a4d4280[here] to the firewall configuration.
====
