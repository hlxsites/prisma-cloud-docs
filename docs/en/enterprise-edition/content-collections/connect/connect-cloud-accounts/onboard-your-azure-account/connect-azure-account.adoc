...
* Entra ID works only when soft delete is disabled. For more information, reference https://learn.microsoft.com/en-us/fabric/data-factory/connector-troubleshoot-azure-data-lake-storage#error-code-adlsgen2operationfailed[Microsoft documentation]. +
