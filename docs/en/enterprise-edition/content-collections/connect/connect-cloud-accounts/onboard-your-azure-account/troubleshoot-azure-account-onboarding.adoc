...
.. Log in to the Azure portal and select *Network{sp}Watcher[Overview]* and verify that the status is *Enabled*.
...
.. Log in to the Azure portal, and select *Network{sp}Watcher[NSG Flow Logs]* and verify that the status is *Enabled*.
