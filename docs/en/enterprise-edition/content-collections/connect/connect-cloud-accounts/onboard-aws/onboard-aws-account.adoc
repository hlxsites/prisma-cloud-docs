...
** Enable *Data Security* to scan your assets to prevent data leaks. This feature is not enabled by default. After you onboard your account, further steps are required to xref:../../../data-security-posture-management/prisma-cloud-dspm-deployment/subscribe-dspm.adoc[Subscribe to Data Security] scans.
