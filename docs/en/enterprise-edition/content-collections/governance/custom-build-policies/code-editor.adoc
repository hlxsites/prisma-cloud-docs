...
. Select *Governance > Add Policy > Config > Add Details* and then select *Next*.
+
...
. Select *Scan* to test your custom code.
//+
...
* *guidelines*: Provides guidance for developers who violate the policy
...
* *scope*: Defines the cloud provider for the policy
