...
* This query returns the net effective permissions of a user in your cloud account named `my-user`:
+
...
* This query lists all effective permissions that have been granted to a user by any AWS IAM group:
+
