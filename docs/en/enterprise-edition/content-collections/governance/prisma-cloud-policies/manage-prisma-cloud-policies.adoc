...
[.procedure]
. To enable global settings for Prisma Cloud default policies click Settings image:settings-icon.png[] and select *Enterprise Settings*.
+
...
====
* The audit logs include a record of all activities performed or initiated on Prisma Cloud. To view the audit logs click Settings image:settings-icon.png[] and select *Audit Logs*.
...
+
image::governance/add-visualization.png[]
...
+
image::governance/manage-policies.png[]
...
====
+
image::governance/edit-custom-policy.png[]
...
+
image::governance/clone-policy.png[]

. View *Alerts* associated with a policy.
+
image::governance/view-policy-alerts.png[]
