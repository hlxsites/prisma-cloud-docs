...
+
NOTE: You cannot run a *New Search* in this workflow. However, you can run a new search from the xref:../search-and-investigate/explore-data.adoc[Investigate] page and save the query as a custom Attack Path policy.
+
