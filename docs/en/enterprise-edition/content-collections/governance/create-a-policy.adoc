...
.. Select *Run* or *Build*
+
Build phase policies do not support remediation CLI. 
//You can however add the instructions for manually fixing the issue in the *Recommendation for Remediation*. You can add instructions either via a YAML editor or an API. 
