...
|xref:.create-an-iam-policy.adoc[Create an IAM Policy - Prisma Cloud]
...
|xref:custom-build-policies/custom-build-policies.adoc[Custom Build Policies Management]
