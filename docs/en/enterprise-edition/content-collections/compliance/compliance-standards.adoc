...
Use the *Compliance > Standards* to oversee the risk across all the supported cloud platforms and gauge the effectiveness of the security processes and controls you have implemented to keep your enterprise secure. 
In addition to the built-in standards, if you want to create a custom standard, combine the out-of-the-box policies along with any custom policies to implement your internal cloud security and compliance standards and policies. This custom standard is also displayed on this Compliance Standards page and the *Created By*  is attributed to you.
