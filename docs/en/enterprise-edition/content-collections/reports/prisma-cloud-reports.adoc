...
// |*Command Center*
// |Share Command Center reports with stakeholders to keep them abreast of the security and compliance status of your cloud assets, and to prioritize the resolution of alerts. (commenting out till ready)
...
* xref:reports/create-and-manage-reports.adoc[Create and Manage Reports]
