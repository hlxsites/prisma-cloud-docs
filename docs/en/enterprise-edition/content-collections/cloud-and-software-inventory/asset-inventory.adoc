...
** *Attack Paths*—Identifies potential Attack Paths within the asset.
...
** *Identity*—Displays xref:../administration/configure-iam-security/cloud-identity-inventory.adoc[effective permissions] for the assets. 
