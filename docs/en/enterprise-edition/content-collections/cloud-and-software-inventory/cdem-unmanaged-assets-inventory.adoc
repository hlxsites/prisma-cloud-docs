...
. tt:[Optional] While inspecting unmanaged assets, you can choose to snooze your known internet-exposed assets, such as test or vendor-exposed assets. Snoozing known assets allows you to view your *Active* assets separately from the *Snoozed* assets by applying the *Status Filter*. To snooze an asset, perform the following steps:
+
...
Once snoozed, set the *Status* filter to *Snoozed* on the *Inventory > Unmanaged Assets* page. This will display the list of snoozed assets, including the snooze duration and reasons for snoozing.
