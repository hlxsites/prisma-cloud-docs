...
+
(tt:[NOTE]) If you do not see any *Applications*, you can define custom xref:#appdna-discovery-criteria[Discovery Criteria] or xref:#appdna-create-apps[Create Application] and enable application scanning.
