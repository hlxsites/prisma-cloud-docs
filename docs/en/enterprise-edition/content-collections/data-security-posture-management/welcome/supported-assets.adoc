...
NOTE: While the above list refers to only data classification, Prisma Cloud discovers and monitors most cloud assets and services for usage and misconfigurations.