== Begin your Prisma Cloud Journey
...
* xref:../connect/connect-cloud-accounts/connect-cloud-accounts.adoc[Onboard your cloud accounts for visibility into cloud resources] 
