...
* If a System Administrator added you to a tenant you will receive two emails. Use the _Welcome to Prisma Cloud Support_ email to activate the CSP account and set a password to access the Palo Alto Networks Support portal. Select Get Started in the _Welcome to Prisma Cloud Networks Support_ email to log in to your Prisma Cloud instance.
