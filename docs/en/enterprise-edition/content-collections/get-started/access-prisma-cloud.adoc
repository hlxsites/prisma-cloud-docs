...
+
Navigate to https://appX.prismacloud.io/login (where X is the instance where your tenant is provisioned, for example app3) and enter your username and password. 
