...
+
Navigate to https://appX<where X is the instance where your tenant is provisioned, for example app3>.prismacloud.io/login and enter your username and password. 
