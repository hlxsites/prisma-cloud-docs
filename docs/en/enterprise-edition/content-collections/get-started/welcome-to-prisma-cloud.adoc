...
As a cloud practioner you know that when it comes to the cloud you can't protect what you can't detect. Prisma Cloud is your trusted Cloud Native Application Protection Platform (CNAPP), providing you with the industry’s broadest security and compliance coverage for applications, data, and infrastructure, helping you secure your entire technology stack, from Code to Cloud.
...
The Prisma Cloud platform meets you where you are in your cloud journey. Easily get started by adopting the capabilities that align with your phase of the cloud journey:
...
Select a persona from the Prisma Cloud console to efficiently navigate between the full set of features available for each phase of your cloud journey.
