...
Share the custom dashboards you have created with members of your organization or tenant to further collaboration and communication. Once you've configured the dashboard access levels, sharing is as simple as updating visibility settings and providing the URL to your team. The steps below capture the workflow:
...
. *Share Dashboards: Update Visibility Setting*

.. Selct *Dashboards> Menu > Manage Views*.
.. Locate your custom dashboard and toggle on the *Visibility* setting.
.. Drag your custom dashboard to the top four of the list, to make it visible to other users, when they log into your tenant and view the Dashboards page. 
.. Share the URL of your dashboard with anyone in your organization to provide access. If the user you wish to share a dashboard with, is currently on the Dashboards page, they will need to refresh the page to see the shared dashboard.
