...
.. Drag your dashboards to the top four so that they will be visible to other users when they log in to your Prisma Cloud tenant.
.. Share the URL of your dashboard with anyone in your organization to provide access.
. Access levels can be changed at anytime by repeating the steps above and switching the access level. 
