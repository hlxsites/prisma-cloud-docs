...
NOTE: If you are a user and you've received a URL for a shared Dashboard and you haven't updated the dashboard's *Visbility* settings, the shared Dashboard will only show up temporarily. To ensure it's always accessible follow the steps listed above. 
