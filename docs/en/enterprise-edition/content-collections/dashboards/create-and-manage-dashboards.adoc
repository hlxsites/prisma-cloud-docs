...
.. Locate your custom dashboard and toggle on the *Visibility* setting. Once the dashboard is shared globally, it will appear at the bottom of the *Manage Dashboards* list and can be reordered to the top by individual users for easy access.  
