...
.. Select *Make this dashboard visible to all viewers* to provide access to all users.
.. You also have the option to select the *Public - anyone in your tenant can view* to provide access to users in your tenant.
