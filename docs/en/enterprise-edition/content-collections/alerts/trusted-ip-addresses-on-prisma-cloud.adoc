...
+
You can also choose various resource types or identifiers for which you want to xref:suppress-alerts-for-prisma-cloud-anomaly-policies.adoc[Suppress Alerts for Prisma Cloud Anomaly Policies].
