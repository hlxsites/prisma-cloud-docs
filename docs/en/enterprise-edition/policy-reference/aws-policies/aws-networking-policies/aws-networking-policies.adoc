...
|xref:bc-aws-365.adoc[SES Configuration Set does not enforces TLS usage]
| https://github.com/bridgecrewio/checkov/blob/main/checkov/terraform/checks/resource/aws/SesConfigurationSetDefinesTLS.py
|MEDIUM
