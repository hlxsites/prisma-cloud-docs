...
This policy with the ID 'CKV_GCP_113' falls under the category of IAM (Identity and Access Management). It is titled 'Ensure IAM policy should not define public access'. This means the policy is designed to check for any IAM policies that might have been defined to allow public access.
