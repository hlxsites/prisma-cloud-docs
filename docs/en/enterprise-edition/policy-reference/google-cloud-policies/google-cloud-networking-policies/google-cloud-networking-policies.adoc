...
| https://github.com/bridgecrewio/checkov/blob/main/checkov/terraform/checks/graph_checks/gcp/GCPVertexRuntimePrivate.yaml
|MEDIUM


|xref:bc-google-cloud-2-32.adoc[The TPU v2 is public]
| https://github.com/bridgecrewio/checkov/blob/main/checkov/terraform/checks/graph_checks/gcp/GCPTpuV2VmPrivateEndpoint.yaml
|MEDIUM


|xref:bc-google-cloud-2-33.adoc[Vertex AI endpoint is public]
| https://github.com/bridgecrewio/checkov/blob/main/checkov/terraform/checks/graph_checks/gcp/GCPVertexAIPrivateEndpoint.yaml
|MEDIUM


|xref:bc-google-cloud-2-34.adoc[Vertex AI index endpoint is public]
| https://github.com/bridgecrewio/checkov/blob/main/checkov/terraform/checks/graph_checks/gcp/GCPVertexAIPrivateIndexEndpoint.yaml
|MEDIUM
