...
On the Prisma Cloud management console, if you want to find all policies available for the build phase set the search filter for *Policy Sub Type* to *Build*. See xref:../../enterprise-edition/content-collections/governance/manage-prisma-cloud-policies.adoc[manage policies] for details.