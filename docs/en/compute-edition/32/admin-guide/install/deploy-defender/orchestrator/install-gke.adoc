...
[NOTE] 
====
To ensure Defender works properly when Anthos Service Mesh is running on GKE, make sure the *Monitor Istio* option is set to *Off* during Defender deployment. This option is relevant only for Istio Service Mesh, not Anthos Service Mesh. You can find this option in the Network section on the Advanced Settings page. Navigate to *Manage* > *Defenders* > *“Manual Deploy”* > *Orchestrator* > *“Orchestrator type = Kubernetes"* > *Advanced Settings*.
====
