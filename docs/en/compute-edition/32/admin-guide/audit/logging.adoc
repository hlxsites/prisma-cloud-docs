...
.. On *Enter the certificate for Syslog TLS* upload the certificate in a PEM format.
  This certificate will encrypt the syslog messages ensuring they are securely sent over HTTPS.
