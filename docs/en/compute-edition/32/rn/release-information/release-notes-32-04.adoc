...
You can upgrade the Prisma Cloud console from one major release to the next major release. For example: With the `v32.xx` as the n release, `v30.xx` as n-2 and `v31.xx` as n-1 release, you can directly upgrade from any `v30.01.153` maintenance release to `v31.00.129`.
...
There is no backward compatibility for new features for this release.
