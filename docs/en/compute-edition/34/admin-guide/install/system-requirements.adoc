...
[CAUTION]
====
It is not recommended to run both Cortex XDR and the Prisma Cloud Defender on the same workload. This setup has not been validated and could potentially result in memory or resource-related problems.
====
