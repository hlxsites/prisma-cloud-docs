...
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=hardware
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=x86-operating-systems
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=arm-operating-systems
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=docker
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=x86-orchestrators
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=arm-orchestrators
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=vulnerability-scanning
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=compliance-scanning
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=runtime-protection
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=waas
|===
...
[format=csv, options="header"]
|===
https://main\--prisma-cloud-docs-website\--hlxsites.hlx.page/en/compute-edition/assets/quinn-34-system-requirements?sheet=auto-defend
|===
...
[WARNING]
====
Do not deploy the Cortex XDR agent and Prisma Cloud Defender on the same workload. +
* Palo Alto Networks has not validated deployments with both agents on the same workload, and does not support it. +
* The two agents are not designed to co-exist on the same workload. Running them together can cause low-level conflicts, resource contention, and system instability. +
* The two solutions provide overlapping security capabilities. Deploying both agents on the same workload results in redundant coverage and consumes system resources without providing additional security.
====
