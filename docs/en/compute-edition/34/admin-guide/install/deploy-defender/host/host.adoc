...
. Install Defender.
  ...
  After the defender installation is complete, To set the `HOST_FIM_MOUNTS` environment variable, update the /var/lib/twistlock/scripts/defender.conf file   with the  value of this new variable is a colon separated list of the additional mountpoints to track (example: "/mnt/mountpoint1:/mnt/mountpoint2"
