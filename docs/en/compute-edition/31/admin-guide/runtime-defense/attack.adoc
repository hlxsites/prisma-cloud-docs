...
|===
include::https://main\--prisma-cloud-docs-website\--hlxsites.hlx.live/en/compute-edition/assets/audits-to-techniques-mapping-attack-explorer?sheet=audits-to-techniques
|===
