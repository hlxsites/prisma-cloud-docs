...
. Verify that you have assigned the xref:../vulnerability-management/serverless-functions.adoc#_authenticating_with_aws[correct permissions] required to scan.
