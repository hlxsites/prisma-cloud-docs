...
You can find the full vulnerabilities report xref:console-vulnerabilities.adoc[here].
...
You can find the full vulnerabilities report xref:defender-vulnerabilities.adoc[here].
