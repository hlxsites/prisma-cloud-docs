...
+
image::aws_agentless_permissions_stack.png[]
+
WAAS agentless resources stack deployed in AWS:
+
image::aws_agentless_setup_stack.png[]
+
...
.. Select *Add*.
+
image::create-vpc-configuration.png[]
+
...
+
image::add-an-app-vpc-traffic-mirroring.png[]
...
+
image::waas_out_of_band_app_firewall.png[]
+
...
+
image::waas_out_of_band_bot_protection.png[]
+
...
+
image::waas_out_of_band_advanced_settings.png[]
...
+
image::waas_out_of_band_rule_overview.png[]
...
image::waas-agentless-rules.png[]
...
image::err1-failed-to-setup-vpc.png[]
...
image::err3-session-already-in-use.png[]
...
image::err5-failed-to-find-vms.png[]
