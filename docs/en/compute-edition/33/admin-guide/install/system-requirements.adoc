...
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=hardware
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=x86-operating-systems
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=arm-operating-systems
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=docker
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=x86-orchestrators
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=arm-orchestrators
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=vulnerability-scanning
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=compliance-scanning
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=runtime-protection
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=waas
|===
...
[format=csv, options="header"]
|===
https://docs.prismacloud.io/en/compute-edition/assets/pascal-33-system-requirements?sheet=auto-defend
|===
