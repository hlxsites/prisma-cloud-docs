...
https://cdn.twistlock.com/releases/oPTOxren/prisma_cloud_compute_edition_33_00_168.tar.gz[https://cdn.twistlock.com/releases/oPTOxren/prisma_cloud_compute_edition_33_00_168.tar.gz]
